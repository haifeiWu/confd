...
Usage of ./confd:
  -accessKey string
        the accessKey to authenticate in nacos (only used with nacos backends)
  -app-id string
  ...
  -client-cert string
        the client cert
  -client-insecure
        Allow connections to SSL sites without certs (only used with -backend=etcd)
  -client-key string
        the client key
  -confdir string
  ...
  -group string
        the group in nacos (only used with nacos backends) (default "DEFAULT_GROUP")
  -interval int
  ...
  -namespace string
        the namespace in nacos (only used with nacos backends)
  -node value
  ...
  -secretKey string
        the secretKey to authenticate in nacos (only used with nacos backends)
  -separator string
